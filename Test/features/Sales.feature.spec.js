...
test.describe('Workflows', () => {
  ...
  test('01 - Create, Qualify and Delete a lead', { tag: ['@sales', '@leads'] }, async ({ Given, page, pages, scenarioContext, When, And, Then }) => { 
    ...
    await And('user "creates" the lead', {"dataTable":{"rows":[{"cells":[{"value":"Last Name"},{"value":"Company"}]},{"cells":[{"value":"Jangir"},{"value":"ABC CORP"}]}]}}, { pages, scenarioContext }); 
